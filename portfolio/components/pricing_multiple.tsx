...
const PricingMultiple: React.FC = () => {
  ...
  return (
    <>
      <section id="pricing">
        <h2 id="pricing_vitrine" className="pricing-title">
      ...
      <section id="pricing">
        <h2 id="pricing_Ecommerce" className="pricing-title">
      ...
      <section id="pricing">
        <h2 id="pricing_services" className="pricing-title">
